...
cssToClip.getDropShadow = function(layerDesc)
{
	var isEffectVisible = isTextLayerEffectVisible(layerDesc);
	if(!isEffectVisible)
	{
		return "";
	}
...
cssToClip.getOutline = function(layerDesc)
{
	var isEffectVisible = isTextLayerEffectVisible(layerDesc);
	if(!isEffectVisible)
	{
...
cssToClip.getGradientFill = function(layerDesc)
{
	var isEffectVisible = isTextLayerEffectVisible(layerDesc);
	if(!isEffectVisible)
	{
...
function isTextLayerEffectVisible(layerDesc)
{
	var visible = layerDesc.getVal("layerFXVisible");
	return visible;
}

//////////////////////////////////// Through //////////////////////////////////////begin
function collectLayersByMixedAPI(layers)
{
	...
	for(var i = 0, len = layers.length; i < len; i++)
	{
		...
		var outline_rgb = cssToClip.getOutline(layerDesc);
		if(outline_rgb != "")
		{
		...
		var shadow_rgb = cssToClip.getDropShadow(layerDesc);
		if(shadow_rgb != "")
		{
		...
		var gradient_rgb = cssToClip.getGradientFill(layerDesc);
		if(gradient_rgb != "")
		{
...
///////////////main
var lyrs = collectLayersByMixedAPI(app.activeDocument.layers);
